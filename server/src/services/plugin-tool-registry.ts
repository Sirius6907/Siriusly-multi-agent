...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@siriusly/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: SiriusPluginManifestV1, pluginDbId?: string): void;
