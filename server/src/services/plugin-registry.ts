 ...
 * the Sirius EcoSystem service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: SiriusPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a Sirius EcoSystem object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
