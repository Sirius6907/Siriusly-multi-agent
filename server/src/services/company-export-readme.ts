 ...
 */
import type { CompanyPortabilityManifest } from "@siriusly/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Sirius EcoSystem](https://sirius.eco)");
  lines.push("");
