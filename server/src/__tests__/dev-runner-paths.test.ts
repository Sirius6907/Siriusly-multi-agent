...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Sirius EcoSystem state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".sirius/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/sirius",
      ),
    ).toBe(false);
