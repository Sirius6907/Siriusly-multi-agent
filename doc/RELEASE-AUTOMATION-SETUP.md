...
This document covers the GitHub and npm setup required for the current Sirius EcoSystem release model:
...
Do this for every public package that Sirius EcoSystem publishes.
...
3. add a trusted publisher for the GitHub repository `siriusly/sirius`
...
2. revoke any personal automation token that used to publish Sirius EcoSystem
