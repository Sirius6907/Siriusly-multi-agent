...
This is intentionally separate from the normal Sirius EcoSystem dev image.
...
```sh
review-checkout-pr siriusly/sirius 432
cd /work/checkouts/siriusly-sirius/pr-432
```
...
## Preview the Sirius EcoSystem app from the PR
...
- Sirius EcoSystem's embedded PostgreSQL and local storage stay inside the container home volume via `SIRIUS_HOME=/home/reviewer/.sirius-review`.
