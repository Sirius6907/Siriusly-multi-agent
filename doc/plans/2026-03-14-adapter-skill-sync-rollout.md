...
This document defines the rollout plan for adapter-wide skill support in Sirius EcoSystem.
...
- Sirius EcoSystem stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

Sirius EcoSystem currently has these adapters:
...
1. Desired skills live in Sirius EcoSystem for every adapter.
...
These adapters have a stable local skills directory that Sirius EcoSystem can read and manage.
...
These adapters do not have a meaningful Sirius EcoSystem-owned persistent install state.
...
- show desired Sirius EcoSystem skills
...
- desired skills stored in Sirius EcoSystem
...
- runtime already injects Sirius EcoSystem skills into `~/.cursor/skills`
...
4. Distinguish:
   - managed Sirius EcoSystem skills
...
- runtime already injects Sirius EcoSystem skills into `~/.gemini/skills`
...
- runtime already injects Sirius EcoSystem skills into `~/.pi/agent/skills`
...
- Sirius EcoSystem can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects Sirius EcoSystem skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- Sirius EcoSystem may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed Sirius EcoSystem skills that are clearly marked as Sirius EcoSystem-managed
...
- Sirius EcoSystem stores desired skills only
...
- avoid destructive wording unless Sirius EcoSystem can prove a skill is Sirius EcoSystem-managed
...
That gets Sirius EcoSystem from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
