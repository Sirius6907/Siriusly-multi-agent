...
- installed adapter list for this Sirius EcoSystem instance
...
## 8. New Skill: `sirius-create-agent`

Create new skill directory:

- `skills/sirius-create-agent/SKILL.md`
...
Also update `skills/sirius/SKILL.md` to reference this skill for hiring workflows.
...
- `sirius-create-agent` skill + docs updates
