...
Sirius EcoSystem already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Sirius EcoSystem should implement next.

## Product Goals

Sirius EcoSystem should let operators:
...
For the next implementation pass, Sirius EcoSystem should enforce these defaults:
...
Sirius EcoSystem should separate subscription-included usage from billed spend:
...
Sirius EcoSystem should have two threshold classes:
...
Sirius EcoSystem must know that a project is budget-paused and enforce it.
...
Sirius EcoSystem must also block execution before new work starts.
