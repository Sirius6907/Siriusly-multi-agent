...
name: design-guide
description: >
  Sirius EcoSystem UI design system guide for building consistent, reusable frontend
...
# Sirius EcoSystem Design Guide

Sirius EcoSystem's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Sirius EcoSystem-specific design language.
