# Sirius EcoSystem Evals

Eval framework for testing Sirius EcoSystem agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Sirius EcoSystem heartbeat skill:
