...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@siriusly/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@siriusly/adapter-utils").TranscriptEntry[];
