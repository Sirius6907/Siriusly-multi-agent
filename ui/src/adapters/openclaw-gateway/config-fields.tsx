...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="Sirius EcoSystem API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
                  "siriusApiUrl",
                  String(config.siriusApiUrl ?? ""),
                )
              }
              onCommit={(v) => mark("adapterConfig", "siriusApiUrl", v || undefined)}
              immediate
              className={inputClass}
              placeholder="https://sirius.example"
            />
          </Field>
          ...
          {sessionStrategy === "fixed" && (
            <Field label="Session key">
              <DraftInput
                value={eff("adapterConfig", "sessionKey", String(config.sessionKey ?? "sirius"))}
