...
export const DISMISSED_KEY = "sirius:inbox:dismissed";
export const READ_ITEMS_KEY = "sirius:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "sirius:inbox:last-tab";
