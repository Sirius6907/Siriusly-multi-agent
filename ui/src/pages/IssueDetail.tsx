...
import type { ActivityEvent } from "@siriusly/shared";
import type { Agent, Issue, IssueAttachment, IssueComment } from "@siriusly/shared";
  ...
  const attachmentUploadButton = (
    <>
      ...
      >
        ...
        <h3 className="text-sm font-medium">Files</h3>{uploadAttachment.isPending || importMarkdownDocument.isPending ? "Uploading..." : (
          <>
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`sirius:issue-comment-draft:${issue.id}`}
            enableReassign
