...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "sirius":
      return { icon: Crown, label: sourceLabel ?? "Sirius EcoSystem", managedLabel: "Sirius EcoSystem managed" };
    default:
  ...
  const createSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        tone: "success",
        title: "Skill created",
        body: `${skill.name} is now editable in the Sirius EcoSystem workspace.`,
      });
    },
    onError: (error) => {
      pushToast({
