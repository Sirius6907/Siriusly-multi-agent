 ...
 *
 * This is placed on `globalThis.__siriusPluginBridge__` and consumed by
...
declare global {
  ...
  var __siriusPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__siriusPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__siriusPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
