...
import type { Company } from "@siriusly/shared";
import { CompanyPatternIcon } from "./CompanyPatternIcon";

const ORDER_STORAGE_KEY = "sirius.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Sirius EcoSystem icon - aligned with top sections (implied line, no visible border) */}
      <div className="w-12 h-12 flex items-center justify-center border-b border-border/40 hover:bg-muted/50 transition-colors">
