...
import { AGENT_ADAPTER_TYPES } from "@siriusly/shared";
import type {
  Agent,
...
// Canonical type lives in @siriusly/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@siriusly/adapter-utils";
import type { CreateConfigValues } from "@siriusly/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        SIRIUS_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
