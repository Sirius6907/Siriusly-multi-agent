...
import type { IssueComment, Agent } from "@siriusly/shared";
          ...
          {(imageUploadHandler || onAttachImage) && (
            <div className="mr-auto flex items-center gap-3">
              ...
              <Button
                ...
                title="Attach image"
              >
                <div className="flex items-center justify-center p-3 sm:p-4 bg-muted/30 group-hover:bg-muted/50 transition-colors">
