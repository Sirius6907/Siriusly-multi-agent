...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within SiriusPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Sirius EcoSystem host.
 *
...
export interface SiriusPluginManifestV1 {
   ...
   */
  minimumSiriusVersion?: PluginMinimumHostVersion;
