import type { PluginLauncherRegistration } from "@siriusly/plugin-sdk";

export const PLUGIN_ID = "sirius-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".sirius-kitchen-sink-demo.txt",
} as const;
