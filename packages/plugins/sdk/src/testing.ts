...
function requireCapability(manifest: SiriusPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Sirius EcoSystem server runtime.
 */
