...
export type { PluginLauncherRenderContextSnapshot } from "@siriusly/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Sirius EcoSystem messages.
 */
...
/**
 * Sirius EcoSystem plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Sirius EcoSystem instance. */
    instanceId: string;
