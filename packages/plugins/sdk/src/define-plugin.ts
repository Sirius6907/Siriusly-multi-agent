/**
 * `definePlugin` — the top-level helper for authoring a Sirius EcoSystem plugin.
 *
...
// ---------------------------------------------------------------------------
// SiriusPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
...
/**
 * Define a Sirius EcoSystem plugin.
 *
 ...
 * @returns A sealed `SiriusPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@siriusly/plugin-sdk";
