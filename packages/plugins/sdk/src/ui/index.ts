/**
 * `@siriusly/plugin-sdk/ui` — Sirius EcoSystem plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@siriusly/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@siriusly/plugin-sdk/ui";
 *
