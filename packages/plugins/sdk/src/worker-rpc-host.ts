...
import type { SiriusPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@siriusly/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: SiriusPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@siriusly/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
