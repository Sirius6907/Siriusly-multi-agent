...
import type { PluginCategory, PluginStatus, SiriusPluginManifestV1 } from "@siriusly/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<SiriusPluginManifestV1>().notNull(),
