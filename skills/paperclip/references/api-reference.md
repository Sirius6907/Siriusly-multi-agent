# Sirius EcoSystem API Reference

Detailed reference for the Sirius EcoSystem control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Sirius EcoSystem Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "sirius-mobile",
    "cwd": "/Users/me/sirius-mobile",
    "repoUrl": "https://github.com/acme/sirius-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `sirius-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
