# Sirius EcoSystem Create Agent API Reference
...
- After approval resolution, requester may be woken with `SIRIUS_APPROVAL_ID` and should reconcile linked issues.
