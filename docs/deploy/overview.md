...
Sirius EcoSystem supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Sirius EcoSystem?** Use `local_trusted` (the default)
