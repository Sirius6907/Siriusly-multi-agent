...
summary: What adapters are and how they connect agents to Sirius EcoSystem
---

Adapters are the bridge between Sirius EcoSystem's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Sirius EcoSystem:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `siriusly run --watch`
```
