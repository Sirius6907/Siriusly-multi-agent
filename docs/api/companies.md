...
Manage companies within your Sirius EcoSystem instance.
...
Company logo uploads use the normal Sirius EcoSystem attachment size limit.
...
| `logoUrl` | string | Optional Sirius EcoSystem asset content path for the stored logo image |
